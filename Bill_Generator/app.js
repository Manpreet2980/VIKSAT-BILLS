...
All disputes are subject to Kharar jurisdiction.`;
  ...
  btnWhatsapp.addEventListener('click', () => {
    ...
    const dNo = (inputDocNo.value || 'INV-VDS-2026-052').trim();
  ...
  btnNewInvoice.addEventListener('click', () => {
    const currentNo = inputDocNo.value.trim();
  ...
  if (!inputDocNo.value) inputDocNo.value = 'INV-VDS-2026-052';
  ...
  inputDocType.addEventListener('change', () => {
    ...
    if (val === 'Tax Invoice' && (!inputDocNo.value || inputDocNo.value.startsWith('QTN-'))) {
      inputDocNo.value = 'INV-VDS-2026-052';
    } else if (val === 'Quotation' && (!inputDocNo.value || inputDocNo.value.startsWith('INV-'))) {
      inputDocNo.value = 'QTN-VDS-2026-052';
    }
    updatePreview();
  });
  ...
  function updatePreview() {
    ...
    const docNo = inputDocNo.value || 'INV-VDS-2026-052';
  ...
  btnQuickLogLedger.addEventListener('click', () => {
    ...
    const docNo = (inputDocNo.value || 'INV-VDS-2026-052').trim();
  ...
  function openLedgerModal(record) {
    ...
    modalDocNo.value = record.docNo || 'INV-VDS-2026-052';
  ...
  formLedgerRecord.addEventListener('submit', (e) => {
    ...
    const docNo = modalDocNo.value.trim() || 'INV-VDS-2026-052';
  ...
  btnLoadDraft.addEventListener('click', () => {
    ...
    inputDocNo.value = draft.docNo || 'INV-VDS-2026-052';
